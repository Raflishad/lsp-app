...
<head>
    ...
    <link rel="icon" href="<?= BASE_URL ?>/<?= BASE_URL ?>/assets/img/logo-smart2.png" type="image/png">
    <link href="<?= BASE_URL ?>/<?= BASE_URL ?>/assets/css/output.css" rel="stylesheet">
...
<body class="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#2D336B] to-[#0C0E24] font-poppins px-4">
    ...
    <?php if (isset($_SESSION['error'])): ?>
        <div class="mb-4 text-red-500 text-sm"><?= $_SESSION['error'];
