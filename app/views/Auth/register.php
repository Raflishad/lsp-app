        ...
        <div class="bg-white px-6 py-8 sm:px-8 rounded-2xl shadow-xl w-full max-w-md">
            ...
            <form action="<?= BASE_URL ?>/AuthController/store" method="POST" data-aos="zoom-in" data-aos-delay="100" data-aos-duration="1000">
                <div class="mb-4 text-left">
                    ...
                    <input type="nama" id="nama" placeholder="Masukkan nama lengkap" required
                        class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm">
                </div>

                <div class="mb-4 text-left">
                    <label for="username" class="block text-sm font-medium text-gray-600 mb-1">Username</label>
                    <input type="username" id="username" placeholder="Buat username" required
                        class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm">
                </div>

                <div class="mb-4 text-left relative">
                    <label for="password" class="block text-sm font-medium text-gray-600 mb-1">Password</label>
                    <input type="password" id="password" placeholder="Buat password" autocomplete="new-password" required class="w-full px-4 py-2 pr-10 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm">
