...
<html lang="id">
    ...
    <body class="relative font-poppins scroll-smooth">

        <nav class="absolute top-0 left-0 w-full flex items-center px-15 py-4 z-50">
            <div class="flex-1">
                <img src="../assets/img/logo1.png" alt="Logo" class="h-12">
            </div>
            <div class="hidden md:flex flex-1 justify-center space-x-8 mt-2 text-white">
                <a href="<?= BASE_URL ?>/AuthController" class="px-4 py-2 transition-transform duration-300 transform hover:text-blue-300 hover:scale-110">Beranda</a>
                <a href="<?= BASE_URL ?>/AuthController" class="px-4 py-2 transition-transform duration-300 transform hover:text-blue-300 hover:scale-110">Berkas</a>
                <a href="<?= BASE_URL ?>/AuthController" class="px-4 py-2 transition-transform duration-300 transform hover:text-blue-300 hover:scale-110">Asesmen Mandiri</a>
            </div>        
            <div class="flex-1 flex justify-end mt-2">
                <a href="<?= BASE_URL ?>/AuthController" class="bg-white px-8 py-2 rounded-full text-blue-500 font-bold will-change-transform transition-transform hover:transform hover:scale-110">
                    Login
                </a>
            </div>
        </nav>
        ...
        <div class="relative w-full h-screen" id="hero">
            ...
            <div class="absolute inset-0 flex flex-col justify-center items-center text-center text-white px-6 z-10">
                <h1 class="text-5xl md:text-6xl font-bold drop-shadow-lg">
                    Selamat Datang di LSP SMART 2
                </h1>
                <p class="mt-5 text-lg md:text-xl max-w-2xl drop-shadow-md">
                    Kami hadir untuk memberikan sertifikasi profesi yang berkualitas dan terpercaya.
                </p>
                <a href="#alur-pendaftaran" class="mt-5 bg-blue-700 px-7 py-3 rounded-full border border-transparent text-md font-bold hover:bg-transparent hover:border-white transition">
                    Pelajari Lebih Lanjut
                </a>
            </div>
        </div>

        <div class="w-full px-6 py-16 bg-gray-100">
            <div class="text-center mb-12">
            <h2 class="text-4xl font-bold text-[#2D336B]">Tujuan LSP</h2>
            ...
            <div class="relative h-96 rounded-xl overflow-hidden shadow-lg cursor-pointer group">
                <img
                ...
                />
                <div
                class="absolute inset-0 bg-black bg-opacity-40 group-hover:bg-opacity-60 transition duration-500 flex items-end justify-start p-6"
                >
                <p
                    class="text-white text-lg font-semibold text-left transform translate-y-4 opacity-80 group-hover:translate-y-0 group-hover:opacity-100 transition duration-500"
                >
        ...
        <div class="bg-[#2D336B] py-14 px-20 flex flex-col md:flex-row items-center md:items-start gap-4 w-full" id="alur-pendaftaran">
            <div class="relative w-1/2 h-full flex justify-center pt-10">
            ...
            <div class="text-start md:text-left text-white w-1/2 -ml-20">
            <h2 class="text-3xl font-semibold mb-6">Alur Pendaftaran LSP</h2>
                <ul class="space-y-2 mb-6">
                    <li class="flex items-start">
                    <div class="w-6 h-6 flex items-center justify-center bg-[#2D336B] border-2 border-white text-white rounded-lg mr-3 mb-2">✔</div>
                    <span class="mb-2">Daftar dan login ke akun anda<br>Calon peserta membuat akun dan login ke sistem LSP.</span>
                    </li>
                    <li class="flex items-start">
                    <div class="w-6 h-6 flex items-center justify-center bg-[#2D336B] border-2 border-white text-white rounded-lg mr-3 mb-2">✔</div>
                    <span class="mb-2">Unggah Berkas & Asesmen Mandiri<br>Mengunggah dokumen pendukung dan mengisi asesmen mandiri sesuai skema sertifikasi.</span>
                    </li>
                    <li class="flex items-start">
                    <div class="w-6 h-6 flex items-center justify-center bg-[#2D336B] border-2 border-white text-white rounded-lg mr-3 mb-2">✔</div>
                    <span class="mb-2">Verifikasi oleh Asesor<br>Asesor memeriksa berkas dan hasil asesmen mandiri sebelum peserta mengikuti uji kompetensi.</span>
                    </li>
                    <li class="flex items-start">
                    <div class="w-6 h-6 flex items-center justify-center bg-[#2D336B] border-2 border-white text-white rounded-lg mr-3 mb-2">✔</div>
                    <span class="mb-2">Uji Kompetensi<br>Peserta mengikuti uji kompetensi yang dilakukan oleh asesor melalui beberapa metode.</span>
                    </li>
                    <li class="flex items-start">
                    <div class="w-6 h-6 flex items-center justify-center bg-[#2D336B] border-2 border-white text-white rounded-lg mr-3 mb-2">✔</div>
                    <span class="mb-2">Sertifikasi Diterbitkan<br>Jika dinyatakan kompeten, peserta mendapatkan sertifikat yang diakui secara nasional.</span>
                    </li>
                </ul>
            <a href="#form-pendaftaran" class="inline-block bg-white text-[#2D336B] font-semibold px-6 py-2 rounded-full  border border-transparent transition hover:bg-transparent hover:text-white hover:border hover:border-white">
                Daftar Sekarang
            </a>
            </div>
        </div>      
        ...
        <div class="bg-white py-16">
            ...
            <h2 class="text-2xl md:text-3xl font-semibold text-[#2D336B] mb-12">
                Statistik Sertifikasi LSP SMART2
            </h2>
            
            <div class="grid grid-cols-2 md:grid-cols-4 gap-2 mx-40">
                <div>
                <div
                    class="bg-[#5B6DFF] text-white text-5xl font-bold w-32 h-32 mx-auto rounded-full flex items-center justify-center
                        transition transform duration-300 hover:bg-[#7D8DFF] hover:scale-105 hover:shadow-lg cursor-pointer">
                    550
                </div>
                <p class="mt-4 text-[#2D336B] font-medium">Siswa Kompeten</p>
                </div>
                <div>
                <div
                    class="bg-[#5B6DFF] text-white text-5xl font-bold w-32 h-32 mx-auto rounded-full flex items-center justify-center
                ...
                <p class="mt-4 text-[#2D336B] font-medium">Asesor Aktif</p>
                </div>
                <div>
                <div
                    class="bg-[#5B6DFF] text-white text-5xl font-bold w-32 h-32 mx-auto rounded-full flex items-center justify-center
                ...
                <p class="mt-4 text-[#2D336B] font-medium">Skema Sertifikasi</p>
                </div>
                <div>
                <div
                    class="bg-[#5B6DFF] text-white text-5xl font-bold w-32 h-32 mx-auto rounded-full flex items-center justify-center
                ...
                <p class="mt-4 text-[#2D336B] font-medium">Industri</p>
                </div>
            </div>
            </div>
        </div>
        ...
        <footer class="bg-[#0c0e24] py-8 mt-10">
            ...
            <div class="flex flex-col md:flex-row md:justify-between md:items-start gap-8">
                ...
                <p class="text-justify md:text-justify max-w-xs">
