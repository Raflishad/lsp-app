                    ...
                    <ul class="space-y-2">
                        <li>
                            <a href="https://www.instagram.com/smkantartika2sda/" target="https://www.instagram.com/smkantartika2sda/" class="flex items-center justify-center md:justify-start gap-2 hover:text-pink-600">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-pink-500" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M7.75 2h8.5A5.75 5.75 0 0122 7.75v8.5A5.75 5.75 0 0116.25 22h-8.5A5.75 5.75 0 012 16.25v-8.5A5.75 5.75 0 017.75 2zm0 1.5A4.25 4.25 0 003.5 7.75v8.5A4.25 4.25 0 007.75 20.5h8.5a4.25 4.25 0 004.25-4.25v-8.5A4.25 4.25 0 0016.25 3.5h-8.5zm8.7 2.2a1.1 1.1 0 110 2.2 1.1 1.1 0 010-2.2zM12 7a5 5 0 110 10 5 5 0 010-10zm0 1.5a3.5 3.5 0 100 7 3.5 3.5 0 000-7z" />
                                </svg>
                                <span>@smkantartika2sda</span>
                            </a>
                        </li>
                        <li class="flex items-center justify-center md:justify-start gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path d="M3 5a2 2 0 012-2h2.586a1 1 0 01.707.293l2.414 2.414a1 1 0 010 1.414L8 10l-1.293 1.293a16 16 0 007.293 7.293L15 16l1.879-1.879a1 1 0 011.414 0l2.414 2.414a1 1 0 01.293.707V19a2 2 0 01-2 2h-1.586a2 2 0 01-1.414-.586l-1.293-1.293a2 2 0 00-2.828 0l-3.536 3.536a1 1 0 01-1.414 0l-3.536-3.536a2 2 0 000-2.828L3.586 12A2 2 0 013 10.586V5z" />
                            </svg>
                        ...
                        <li class="flex items-center justify-center md:justify-start gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path d="M16 12h2a2 2 0 012 2v5a2 2 0 01-2 2h-2m-4-10v6m0 0l-2-2m2 2l2-2m3-6v-1a2 2 0 00-2-2h-6a2 2 0 00-2 2v1m10 0H6" />
                            </svg>
